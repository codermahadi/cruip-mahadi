                ...
                <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
                    ...
                    <div className="sm:col-span-12 lg:col-span-3">
                        ...
                        <div className="text-sm text-gray-600">
                            <Link href="#"><a
                                className="text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out">Terms</a></Link> · <Link
                            href="#"><a
                    ...
                    <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
                        ...
                        <ul className="text-sm">
                            ...
                            <li className="mb-2">
                                <Link href="#"><a
                                    className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Integrations</a></Link>
                            </li>
                            <li className="mb-2">
                                <Link href="#"><a
                                    className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Command-line</a></Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
                        ...
                        <ul className="text-sm">
                            <li className="mb-2">
                                <Link href="#"><a
                                    className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Documentation</a></Link>
                            </li>
                            <li className="mb-2">
                                <Link href="#"><a
                            ...
                            <li className="mb-2">
                                <Link href="#"><a
                                    className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Blog</a></Link>
                            </li>
                            <li className="mb-2">
                                <Link href="#"><a
                            ...
                            <li className="mb-2">
                                <Link href="#"
                                ><a className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Partners</a></Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
                        ...
                        <ul className="text-sm">
                            <li className="mb-2">
                                <Link href="#"
                                ><a className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Home</a></Link>
                            </li>
                            <li className="mb-2">
                                <Link href="#"
                                ><a className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">About
                                    us</a></Link>
                            </li>
                            <li className="mb-2">
                                <Link href="#"
                                ><a className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Company
                                    values</a></Link>
                            </li>
                            <li className="mb-2">
                                <Link href="#"
                                ><a className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Pricing</a></Link>
                            </li>
                            <li className="mb-2">
                                <Link href="#"
                                ><a className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Privacy
                                    Policy</a></Link>
                            </li>
                        </ul>
                    </div>
